...
public class Md5Util {	
     ...
     * @return 
     */
    public static String generateMD5String2(String plainText){
        MessageDigest md;
        try {
            md = MessageDigest.getInstance("MD5");
            md.update(plainText.getBytes());
     ...
     * @return 
     */
    public static String generateMD5String16(String plainText){
        MessageDigest md;
        try {
        	plainText += "123456";
            md = MessageDigest.getInstance("MD5");
    ...
    public static String getMD5(String source) {
		...
		try {
			...
			md.update(source.getBytes("utf-8")); // 通过使用 update 方法处理数据,使指定的 byte数组更新摘要
